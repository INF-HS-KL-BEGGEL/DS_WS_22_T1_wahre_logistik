...
```{r echo=FALSE}
stop("In diesem Kapitel wird die Tabelle für die Kunden-Cluster neu angelegt und befüllt. Wenn du keine Änderungen an den bestehenden Daten machen möchtest, darfst du die verbleibenden Code Chunks in diesem Kapitel nicht ausführen.")
```
