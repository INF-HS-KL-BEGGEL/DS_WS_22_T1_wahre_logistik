...
```{r echo=FALSE}
data_selection_1 = auswertung_nach_distanz[1:5, ]
data_selection_2 = auswertung_nach_distanz[75:79, ]
...
Todo
```{r}
routing_agg_results_enhanced %>% head()
```
