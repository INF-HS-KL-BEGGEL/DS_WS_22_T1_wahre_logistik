...
```{r}
# Bildung eines Rasters, dass die Verjüngung der Erde (zu den Polen hin) berücksichtigt
# Unterschied zwischen Längengraden im Norden und Süden: 3 %
# Abstand zwischne zwei Punkten in lon-Richtung im Süden: ca. 63,1 km
# Abstand zwischne zwei Punkten in lon-Richtung im Norden ca. 65,1 km
# Abstand zwischen zwei Punkten in lat-Richtung: ca. 66,4 km
de_min_long <- 5.8630797
de_max_long <- 15.0644589 
de_min_lat <- 47.2842067
de_max_lat <- 55.0458651
